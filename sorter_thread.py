...
"""
--sourse -s trash  #python3 sorter_thread.py -s garbage
--output -o dist   #python3 sorter_thread.py -s garbage -o name folder
"""
...
if __name__ == '__main__':
    ...
    print(f'Час виконання з потоками {end}')
